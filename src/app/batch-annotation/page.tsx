      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-6 space-y-6 text-left">
          ...
          <p>
            ...
            multiple variants for annotation using HG38 genome assembly.
            Results will be emailed to you when processing is complete. The
            file must be in plain text format with one variant per row.
          </p>
