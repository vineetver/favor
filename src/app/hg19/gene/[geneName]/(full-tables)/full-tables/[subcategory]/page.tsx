...
export default function GeneTablePage() {
  ...
  const displayDescription = useMemo(() => {
    switch (subcategory) {
      case "SNV-table":
        return "Single nucleotide variants with rsID in this gene from hg19";
      case "InDel-table":
        return "Insertion and deletion variants with rsID in this gene from hg19";
      default:
        return "Browse all variants with rsID in this gene from hg19";
    }
  }, [subcategory]);
