...
export default async function GeneLayout({
  ...
  const { geneName, category } = params;
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-6">
            <NavigationTabs
              ...
              activeItem={category}
              basePath={`/hg38/gene/${encodeURIComponent(geneName)}`}
            />
          </div>
          ...
          {currentCategory.subCategories.length > 0 && (
            <div className="mb-6 lg:hidden">
              <MobileSubNavigation
                ...
                basePath={`/hg38/gene/${encodeURIComponent(geneName)}/${category}`}
              />
            </div>
          )}
        </div>
