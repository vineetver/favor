...
export const Tool = ({ className, ...props }: ToolProps) => (
  <Collapsible
    className={cn(
      "group not-prose mb-4 w-full rounded-lg border border-border/80 bg-card shadow-xs",
      className,
    )}
    {...props}
  />
...
export const ToolHeader = ({
  ...
  return (
    <CollapsibleTrigger
      className={cn(
        "flex w-full items-center justify-between gap-4 rounded-t-lg p-3 transition-colors hover:bg-accent/50",
        className,
      )}
      {...props}
    >
