...
export function ForestPlot({
  data, title, xLabel = "Odds Ratio (95% CI)", refLine = 1, logX = true, className,
}: ForestPlotProps) {
    ...
    <div className={className}>
      <Plot
        ...
        layout={{
          ...
          xaxis: { ...PLOTLY_AXIS, title: { text: xLabel, font: { size: 12 } }, type: logX ? "log" : "linear", ...(logX ? { dtick: 1 } : {}) },
          yaxis: { ...PLOTLY_AXIS, automargin: true, tickfont: { size: 13 } },
          shapes: refLine != null ? [{
            type: "line" as const, x0: refLine, x1: refLine,
            y0: -0.5, y1: data.length - 0.5, yref: "y" as const,
