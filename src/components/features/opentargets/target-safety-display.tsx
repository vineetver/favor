...
export function TargetSafetyDisplay({
  target,
  geneName,
}: TargetSafetyDisplayProps) {
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="text-center text-muted-foreground">
            No safety liability data found for {geneName} in OpenTargets
            Platform
          </div>
        </CardContent>
      </Card>
              ...
              {liability.effects && liability.effects.length > 0 && (
                <div>
                  ...
                  <div className="grid gap-2">
                    {liability.effects.map(
                      (effect: any, effectIndex: number) => (
                        <div
                          key={effectIndex}
                        ...
                        >
                          <div className="text-sm">
                            <div className="font-medium">
                              {effect.direction || "Unknown direction"}
                            </div>
                            {effect.dosing && (
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-orange-800">
              The safety liabilities shown here are derived from various sources
              including experimental data, clinical trials, and post-market
              surveillance. This information should be considered in the context
              of drug development and target assessment.
            </p>
          </div>
        </div>
      </div>
