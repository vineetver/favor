...
export function Navbar() {
    ...
    return (
        <>
            ...
            <div
                className={`fixed top-16 left-0 right-0 bottom-0 z-40 transition-all duration-300 ease-in-out md:hidden ${isMobileMenuOpen
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/40 bg-background">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center">
                        ...
                        <div className="md:hidden ml-auto">
                            ...
                            >
                                <Menu
                                    className={`absolute h-6 w-6 transition-all duration-200 ${isMobileMenuOpen
                ...
                {/* Mobile menu */}
                <div
                    className={`md:hidden transition-all duration-300 ease-in-out relative z-50 ${isMobileMenuOpen
