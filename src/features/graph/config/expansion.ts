  ...
  Gene: [
    {
      label: "Find Diseases",
      description:
        "All disease associations (scored, curated, causal, somatic)",
  ...
  Variant: [
    {
      ...
      description:
        "Genes this variant is predicted to implicate (L2G, regulatory, enhancer)",
