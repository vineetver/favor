...
export const geneCancerHallmarksColumns = [
  col.accessor("cancer_hallmarks", {
    ...
    cell: cell.custom<Gene, any>((hallmarks: Array<{ pmid: number; description: string; impact: string; label: string }>) => {
        ...
        <div>
          {hallmarks.map((hallmark, index) => (
            <div key={index}>
              ...
              {hallmark.impact && (
                <div>Impact: {hallmark.impact}</div>
              )}

              {hallmark.description && (
                <div>{hallmark.description}</div>
              )}
  ...
  col.accessor("cancer_attributes", {
    ...
    cell: cell.custom<Gene, any>((attributes: Array<{ pmid: number; description: string; attribute_name: string }>) => {
