...
export const geneConstraintsColumns = [
  ...
  col.accessor("ot_constraints", {
    ...
    description: tooltip({
      ...
      description:
        "Comprehensive genetic constraint scores from gnomAD and other sources via OpenTargets.",
    }),
            ...
            {constraints.map((constraint, index) => (
              <div key={index}>
                ...
                <div>
                  ...
                  {constraint.oeLower !== undefined &&
                    constraint.oeUpper !== undefined && (
                      <div>
                        90% CI: {constraint.oeLower.toFixed(4)} -{" "}
                        {constraint.oeUpper.toFixed(4)}
                      </div>
                    )}
