...
export const HANDLER_EDGE_FIELDS: Record<string, string[] | null> = {
  ...
  VARIANT_ASSOCIATED_WITH_TRAIT__Disease: ["p_value_mlog", "or_beta", "risk_allele", "clinical_significance", "review_status", "trait_name"],
  ...
  VARIANT_ASSOCIATED_WITH_STUDY: ["p_value_mlog", "or_beta", "risk_allele", "study_title", "study_trait", "trait_name"],
