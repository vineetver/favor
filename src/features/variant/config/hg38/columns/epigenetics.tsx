...
export const epigeneticsColumns = [
  ...
  col.accessor("encode_dnase_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.dnase ?? row.main?.encode?.dnase?.phred,
    header: "DNase",
    description: tooltip({
      title: "DNase",
      description:
  ...
  col.accessor("encodeh3k27ac_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h3k27ac ?? row.main?.encode?.h3k27ac?.phred,
    header: "H3K27ac",
    description: tooltip({
      title: "H3K27ac",
      description:
  ...
  col.accessor("encodeh3k4me1_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h3k4me1 ?? row.main?.encode?.h3k4me1?.phred,
    header: "H3K4me1",
    description: tooltip({
      title: "H3K4me1",
      description:
  ...
  col.accessor("encodeh3k4me2_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h3k4me2 ?? row.main?.encode?.h3k4me2?.phred,
    header: "H3K4me2",
    description: tooltip({
      title: "H3K4me2",
      description:
  ...
  col.accessor("encodeh3k4me3_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h3k4me3 ?? row.main?.encode?.h3k4me3?.phred,
    header: "H3K4me3",
    description: tooltip({
      title: "H3K4me3",
      description:
  ...
  col.accessor("encodeh3k9ac_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h3k9ac ?? row.main?.encode?.h3k9ac?.phred,
    header: "H3K9ac",
    description: tooltip({
      title: "H3K9ac",
      description:
  ...
  col.accessor("encodeh4k20me1_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h4k20me1 ?? row.main?.encode?.h4k20me1?.phred,
    header: "H4K20me1",
    description: tooltip({
      title: "H4K20me1",
      description:
  ...
  col.accessor("encodeh2afz_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h2afz ?? row.main?.encode?.h2afz?.phred,
    header: "H2AFZ",
    description: tooltip({
      title: "H2AFZ",
      description:
  ...
  col.accessor("encodeh3k9me3_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h3k9me3 ?? row.main?.encode?.h3k9me3?.phred,
    header: "H3K9me3",
    description: tooltip({
      title: "H3K9me3",
      description:
  ...
  col.accessor("encodeh3k27me3_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h3k27me3 ?? row.main?.encode?.h3k27me3?.phred,
    header: "H3K27me3",
    description: tooltip({
      title: "H3K27me3",
      description:
  ...
  col.accessor("encodeh3k36me3_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h3k36me3 ?? row.main?.encode?.h3k36me3?.phred,
    header: "H3K36me3",
    description: tooltip({
      title: "H3K36me3",
      description:
  ...
  col.accessor("encodeh3k79me2_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.h3k79me2 ?? row.main?.encode?.h3k79me2?.phred,
    header: "H3K79me2",
    description: tooltip({
      title: "H3K79me2",
      description:
  ...
  col.accessor("encodetotal_rna_sum", {
    accessor: (row) =>
      row.epigenetic_phred?.total_rna ?? row.main?.encode?.total_rna?.phred,
    header: "totalRNA",
    description: tooltip({
      title: "Total RNA",
      description:
