...
export const integrativeColumns = [
  ...
  col.accessor("apc_local_nucleotide_diversity_v3", {
    ...
    description: tooltip({
      ...
      description: "Integrative score combining local genetic diversity measures (background selection statistic, recombination rate, nucleotide diversity) into a single PHRED-scaled score. Reflects evolutionary and recombination patterns.",
      range: "[0, 86.238]",
  ...
  col.accessor("apc_mutation_density", {
    ...
    description: tooltip({
      ...
      description: "Integrative score combining mutation densities at different scales (100bp, 1kb, 10kb windows) for common, rare, and singleton variants into a single PHRED-scaled score. Reflects mutational burden in genomic region.",
      range: "[0, 84.477]",
      citation: "Li et al., 2020",
      guides: [
  ...
  col.accessor("apc_mappability", {
    ...
    description: tooltip({
      ...
      description: "Integrative score combining sequence mappability measures at different read lengths (k=24, 36, 50, 100) for unique and multi-mapping reads into a single PHRED-scaled score. Affects sequencing read alignment quality.",
      range: "[0.007, 22.966]",
      citation: "Li et al., 2020",
      guides: [
  ...
  col.accessor("cadd_phred", {
    ...
    description: tooltip({
      title: "CADD PHRED",
      description: "The CADD score in PHRED scale (integrative score). A higher CADD score indicates more deleterious.",
      range: "[0.001, 84]",
      citation: "Kircher et al., 2014; Rentzsch et al., 2018",
      guides: [
        { threshold: "Higher scores (>10)", meaning: "More likely deleterious" },
  ...
  col.accessor("linsight", {
    ...
    description: tooltip({
      title: "LINSIGHT",
      description: "The LINSIGHT score (integrative score). A higher LINSIGHT score indicates more functionality.",
      range: "[0.033, 0.995]",
      citation: "Huang et al., 2017",
      guides: [
        { threshold: "Higher scores (>0.5)", meaning: "More likely functional" },
  ...
  col.accessor("fathmm_xf", {
    ...
    description: tooltip({
      title: "FATHMM-XF",
      description: "The FATHMM-XF score for coding variants (integrative score). A higher FATHMM-XF score indicates more functionality.",
      range: "[0.001, 0.999]",
