...
const alphaMissense = categories([
  {
    ...
    color: "red",
    description: "pathogenicity > 0.564",
  },
  {
    label: "Ambiguous",
    match: /ambiguous/i,
    color: "yellow",
    description: "pathogenicity between 0.34-0.564",
  },
  {
    label: "Likely Benign",
    match: /likely[_\s]benign/i,
    color: "green",
    description: "pathogenicity < 0.34",
  },
]);
...
const sift = categories([
  ...
  },
  {
    ...
    match: /deleterious.*low/i,
    color: "orange",
    description: "may affect protein function",
  },
  {
    label: "Tolerated",
    match: /^tolerated$/i,
    color: "green",
    description: "likely to have no functional impact",
  },
  {
    label: "Tolerated (Low Confidence)",
    match: /tolerated.*low/i,
    color: "lime",
    description: "may have no functional impact",
  },
]);
...
const polyphen = categories([
  {
    ...
    match: /probably[_\s]damaging/i,
    color: "red",
    description: "likely to affect protein function",
  },
  {
    label: "Possibly Damaging",
    match: /possibly[_\s]damaging/i,
    color: "orange",
    description: "may affect protein function",
  },
  {
...
function _ProteinVariant({ value }: { value: string }) {
  ...
  return (
    <span className="font-mono bg-muted/20 px-2 py-1 rounded">{value}</span>
  );
}
...
export const proteinFunctionColumns = [
  ...
  col.accessor("am_class", {
    ...
    description: tooltip({
      ...
      description:
        "Classification of the protein variant into three discrete categories based on pathogenicity score.",
  ...
  col.accessor("polyphen_cat", {
    ...
    description: tooltip({
      ...
      description:
        "PolyPhen predicts the functional significance of an allele replacement using physical and comparative considerations.",
  ...
  col.accessor("metasvm_pred", {
    ...
    description: tooltip({
      ...
      description:
        "Ensemble method combining multiple predictors (SIFT, PolyPhen2, MutationTaster, etc.) using support vector machine to identify disruptive missense variants.",
  ...
  col.accessor("mutation_taster_score", {
    ...
    description: tooltip({
      ...
      description:
        "Evaluates DNA sequence variants for disease-causing potential using multiple in silico tests including evolutionary conservation, splice site changes, and protein features.",
      range: "[0, 1]",
      defaultValue: "0",
      ...
      guides: [
        {
          ...
          meaning: "More likely disease-causing",
        },
        {
          threshold: "Lower scores (<0.5)",
          meaning: "More likely polymorphism",
        },
      ],
    }),
    cell: cell.decimal(3),
  ...
  col.accessor("mutation_assessor_score", {
    ...
    description: tooltip({
      ...
      description:
        "Predicts functional impact of amino-acid substitutions based on evolutionary conservation patterns in protein families.",
      range: "[-5.135, 6.125]",
      defaultValue: "-5.545",
      ...
      guides: [
        ...
        {
          threshold: "Medium (1.935-3.5)",
          meaning: "Medium functional impact",
        },
  ...
  col.accessor("am_pathogenicity", {
    ...
    description: tooltip({
      ...
      description:
        "Calibrated AlphaMissense pathogenicity scores ranging between 0 and 1. Can be interpreted as the predicted probability of a variant being clinically pathogenic.",
      range: "[0, 1]",
      guides: [
  ...
  col.accessor("sift_val", {
    ...
    description: tooltip({
      title: "SIFT Score",
      description:
        "SIFT score ranges from 0.0 (deleterious) to 1.0 (tolerated). Lower scores indicate higher likelihood of functional impact.",
      range: "[0, 1]",
      defaultValue: "1",
      citation: "Ng and Henikoff, 2003",
      guides: [
        {
          threshold: "Lower scores (<0.05)",
          meaning: "Deleterious - affects protein function",
        },
        {
          threshold: "Higher scores (≥0.05)",
          meaning: "Tolerated - likely benign",
        },
      ],
    }),
    cell: cell.decimal(3),
  ...
  col.accessor("polyphen_val", {
    ...
    description: tooltip({
      ...
      description:
        "PolyPhen score predicting functional significance of an allele replacement from its individual features.",
      range: "[0, 1]",
      defaultValue: "0",
      citation: "Adzhubei et al., 2010",
      guides: [
        ...
        {
          threshold: "Medium scores (0.446-0.908)",
          meaning: "Possibly damaging",
        },
  ...
  col.accessor("polyphen2_hdiv_score", {
    ...
    description: tooltip({
      ...
      description:
        "Predicts amino acid substitution impact. Trained on Mendelian disease variants vs. evolutionarily divergent variants from close mammalian species. Better for evaluating rare alleles and Mendelian disease.",
      range: "[0, 1]",
      defaultValue: "0",
      citation: "Adzhubei et al., 2010",
      guides: [
        ...
        {
          threshold: "Medium scores (0.453-0.957)",
          meaning: "Possibly damaging",
        },
  ...
  col.accessor("polyphen2_hvar_score", {
    ...
    description: tooltip({
      ...
      description:
        "Predicts amino acid substitution impact. Trained on human disease variants vs. common polymorphisms (MAF ≥1%). Better for distinguishing disease mutations from common genetic variation.",
      range: "[0, 1]",
      defaultValue: "0",
      citation: "Adzhubei et al., 2010",
      guides: [
        ...
        {
          threshold: "Medium scores (0.447-0.909)",
          meaning: "Possibly damaging",
        },
  ...
  col.accessor("grantham", {
    ...
    description: tooltip({
      ...
      description:
        "Measures evolutionary distance between original and new amino acids based on chemical properties (polarity, molecular volume, composition).",
      range: "[0, 215]",
      defaultValue: "0",
      citation: "Grantham, 1974",
      guides: [
        {
          threshold: "Radical (>100)",
          meaning: "Large chemical difference, more deleterious",
        },
        {
          threshold: "Moderate (51-100)",
          meaning: "Moderate chemical difference",
        },
        {
          threshold: "Conservative (0-50)",
          meaning: "Small chemical difference, more tolerated",
        },
      ],
    }),
    cell: cell.decimal(0),
...
export const proteinFunctionGroup = col.group(
  "protein-function",
  "Protein Function",
