...
export const chromatinStateColumns = [
  ...
  chromatinCol(
    ...
    "Higher counts (>10 cell types)",
    "Broadly active promoter",
    "More cell-type specific activation",
  ),
  chromatinCol(
    "chmm_e2",
    ...
    "Higher counts (>8 cell types)",
    "Broadly active upstream elements",
    "Cell-type specific upstream activity",
  ),
  chromatinCol(
    "chmm_e3",
    ...
    "Higher counts (>8 cell types)",
    "Broadly accessible downstream regions",
    "Cell-type specific downstream activity",
  ),
  chromatinCol(
    "chmm_e4",
    ...
    "Higher counts (>8 cell types)",
    "Broadly active downstream elements",
    "Cell-type specific downstream activity",
  ),
  ...
  chromatinCol(
    ...
    "Higher counts (>15 cell types)",
    "Broadly transcribed 5' regions",
    "Cell-type specific 5' transcription",
  ),
  chromatinCol(
    "chmm_e6",
    "Tx (Transcription)",
    ...
    "Higher counts (>15 cell types)",
    "Broadly transcribed gene bodies",
  ...
  chromatinCol(
    ...
    "Higher counts (>15 cell types)",
    "Broadly transcribed 3' regions",
    "Cell-type specific 3' transcription",
  ),
  chromatinCol(
    "chmm_e8",
    ...
    "Higher counts (>15 cell types)",
    "Broadly weak transcription",
    "Cell-type specific weak activity",
  ),
  ...
  chromatinCol(
    ...
    "Higher counts (>10 cell types)",
    "Broadly regulatory transcription",
  ...
  chromatinCol(
    ...
    "Higher counts (>10 cell types)",
    "Broadly active 5' enhancers",
    "Cell-type specific 5' enhancer activity",
  ),
  chromatinCol(
    "chmm_e11",
    ...
    "Higher counts (>10 cell types)",
    "Broadly active 3' enhancers",
    "Cell-type specific 3' enhancer activity",
  ),
  chromatinCol(
    "chmm_e12",
    ...
    "Higher counts (>10 cell types)",
    "Broadly weak enhancer activity",
    "Cell-type specific weak enhancers",
  ),
  ...
  chromatinCol(
    ...
    "Higher counts (>8 cell types)",
    "Broadly active flanking regions",
    "Cell-type specific flanking activity",
  ),
  ...
  chromatinCol(
    ...
    "Higher counts (>12 cell types)",
    "Broadly weak enhancer",
    "Cell-type specific weak enhancer activity",
  ),
  chromatinCol(
    "chmm_e17",
  ...
  chromatinCol(
    ...
    "Higher counts (>10 cell types)",
    "Broadly acetylated enhancer regions",
    "Cell-type specific acetylation",
  ),
  ...
  chromatinCol(
    ...
    "Higher counts (>20 cell types)",
    "Broadly active ZNF/repeat regions",
    "Cell-type specific ZNF/repeat activity",
  ),
  chromatinCol(
    "chmm_e21",
    "Het (Heterochromatin)",
    ...
    "Higher counts (>30 cell types)",
    "Constitutively silenced regions",
    "Facultatively heterochromatic",
  ),
  ...
  chromatinCol(
    ...
    "Higher counts (>12 cell types)",
    "Broadly poised promoters",
    "Cell-type specific poised states",
  ),
  chromatinCol(
    "chmm_e23",
    ...
    "Higher counts (>15 cell types)",
    "Broadly poised developmental genes",
    "Cell-type specific bivalent states",
  ),
  ...
  chromatinCol(
    ...
    "Higher counts (>20 cell types)",
    "Broadly repressed across contexts",
    "Cell-type specific repression",
  ),
  chromatinCol(
    "chmm_e25",
    "Quies (Quiescent/Low)",
    ...
    "Higher counts (>35 cell types)",
    "Constitutively inactive",
    "Context-dependent activity",
  ),
];

export const chromatinStateGroup = col.group(
  "chromatin-states",
  "Chromatin State",
