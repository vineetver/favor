...
interface SavedSearchesState {
    ...
    saveSearch: (query: string, name: string, genome: GenomicBuild, description?: string) => void;
    deleteSavedSearch: (id: string) => void;
    getSavedSearchItems: () => { type: "saved"; value: string; id: string; data: SavedSearchItem }[];
}
