    ...
    switch (accessor) {
      case "exonic":
        return {
          ...
          interpretation:
            percentage > 10
              ? "High impact (enriched vs 2% genome)"
              : "Moderate impact (2% of genome)",
    ...
    switch (accessor) {
      case "apcproteinfunction":
        return {
          ...
          interpretation: isHighScore
            ? "High likelihood of protein function impact"
            : "Lower likelihood of function impact",
      ...
      default:
        if (accessor.startsWith("apc")) {
          return {
            ...
            interpretation: isHighScore
              ? "High regulatory/epigenetic impact"
...
function BiologicalContextComponent({
  ...
  const context = getBiologicalContext(
    accessor,
    value,
    percentage,
    categorySlug,
  ...
  return (
    <div className="text-left space-y-1">
      <div className="flex justify-left">
        <span
          className={`text-left text-xs font-semibold ${significanceColors[context.significance]} whitespace-nowrap inline-block`}
        >
  ...
  items: [
    {
      ...
      biologicalContext: (
        <BiologicalContextComponent
          accessor="total"
          categorySlug="allele-distribution"
        />
      ),
    },
    {
  ...
  items: [
    {
      ...
      biologicalContext: (
        <BiologicalContextComponent
          accessor="exonic"
          categorySlug="genecode-comprehensive-category"
        />
      ),
    },
    {
...
export const GENE_SUMMARY_CLINVAR: ColumnsType = {
  ...
  items: [
    ...
    },
    {
      ...
      biologicalContext: (
        <BiologicalContextComponent accessor="benign" categorySlug="clinvar" />
      ),
    },
    {
      key: 4,
    ...
    },
    {
      ...
      biologicalContext: (
        <BiologicalContextComponent accessor="unknown" categorySlug="clinvar" />
      ),
    },
    {
      key: 6,
  ...
  items: [
    {
      ...
      biologicalContext: (
        <BiologicalContextComponent
          accessor="plof"
          categorySlug="functional-consequences"
        />
      ),
    },
    {
  ...
  items: [
    ...
    },
    {
      ...
      tooltip: (
        <div className="space-y-2 text-left">
          <p>
            Conservation annotation PC: the first PC of the standardized scores
            of "GerpN, GerpS, priPhCons, mamPhCons, verPhCons, priPhyloP,
            mamPhyloP, verPhyloP" in PHRED scale. Range: [0, 75.824]. (Li et
            al., 2020)
          </p>
          <ul className="list-disc list-inside space-y-1 text-xs">
            <li>
      ...
      biologicalContext: (
        <BiologicalContextComponent
          accessor="apcconservation"
          categorySlug="high-integrative-score"
        />
      ),
    },
    {
      ...
      tooltip: (
        <div className="space-y-2 text-left">
          <p>
            ...
            H4K20me1, H2AFZ) into a single PHRED-scaled score. Range: [0,
      ...
      tooltip: (
        <div className="space-y-2 text-left">
          <p>
            ...
            H3K79me2) into a single PHRED-scaled score. Range: [0, 86.238]. (Li
            et al., 2020)
          </p>
          <div className="flex items-center gap-2 mb-2">
      ...
      tooltip: (
        <div className="space-y-2 text-left">
          <p>
            ...
            for common, rare, and singleton variants into a single PHRED-scaled
            score. Range: [0, 84.477]. (Li et al., 2020)
          </p>
          <ul className="list-disc list-inside space-y-1 text-xs">
            <li>
