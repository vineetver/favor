...
export function createBasePPIColumns(
  selectedNode: string | null,
): ColumnDef<UnifiedPPIInteraction>[] {
  return [
    {
      accessorKey: "gene_a",
      header: ({ column }) => (
...
export function exportTableData(
  ...
  columns: ColumnDef<UnifiedPPIInteraction>[],
  filename: string = "protein-protein-interactions.tsv",
) {
...
export function getUniqueTableValues<T>(
  data: T[],
