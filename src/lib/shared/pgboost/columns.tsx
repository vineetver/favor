...
// Common columns used by both gene and region
const sharedColumns: ColumnDef<PGBoost>[] = [
  {
...
// Gene page columns (rsid first)
export const pgboostGeneColumns: ColumnDef<PGBoost>[] = [
  {
    accessorKey: "rsid",
    header: ({ column }) => (
      <DataTableColumnHeader
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="text-left">
          <Link
            href={`/hg38/rsid/${rsid}/SNV-summary/allele-distribution`}
...
// Region page columns (gene first)
export const pgboostRegionColumns: ColumnDef<PGBoost>[] = [
  {
    accessorKey: "gene",
    header: ({ column }) => (
      <DataTableColumnHeader
