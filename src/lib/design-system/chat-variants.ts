  ...
  'rounded-xl border bg-card text-card-foreground shadow-sm transition-all duration-200',
  {
    variants: {
      variant: {
        ...
        interactive: 'border-border hover:border-border/80 hover:shadow-md cursor-pointer',
        genomics: 'border-primary/25 bg-gradient-to-br from-primary/5 to-primary/10',
      },
      padding: {
        none: 'p-0',
        sm: 'p-3',
