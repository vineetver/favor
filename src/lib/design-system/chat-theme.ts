...
export const chatColors = {
  message: {
    ...
    genomics: 'bg-gradient-to-br from-primary/8 to-primary/12 border border-primary/25',
  ...
  surface: {
    ...
    genomics: 'bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20',
  },
} as const;
